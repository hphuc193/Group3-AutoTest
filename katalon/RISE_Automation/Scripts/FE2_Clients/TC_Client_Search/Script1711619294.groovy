...
/**
 * TC_Client_Search - Data-driven Client Search Test
...
WebUI.click(findTestObject('Page_Clients/input_Search'))
WebUI.clearText(findTestObject('Page_Clients/input_Search'))
WebUI.setText(findTestObject('Page_Clients/input_Search'), keyword)
WebUI.delay(2)
...
if (expectedResult == 'has_results') {
	...
	String tbodyText = driver.findElement(org.openqa.selenium.By.cssSelector('table#client-table tbody')).getText()
